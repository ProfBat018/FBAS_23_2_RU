...
public class AuthService : IAuthService
{
    ...
    public async Task<LogOutResponse> LogOutAsync(ClaimsPrincipal user)
    {
        ...
        foundUser.RefreshTokenExpiration = DateTime.Now;
        
        await _context.SaveChangesAsync();
        
        return new LogOutResponse($"Successfully logged out: {username}");
    }
