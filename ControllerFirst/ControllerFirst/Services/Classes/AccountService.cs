...
public class AccountService : IAccountService
{
    ...
    public AccountService(IMapper mapper, AuthContext authContext, IConfiguration config, ITokenService tokenService, IUserElasticService elasticService, IHubContext<UserNotificationHub> hubContext)
    {
        _mapper = mapper;
    ...
    public async Task ResetPasswordAsync(ResetPasswordRequest request)
    {
        ...
        using FileStream fs = new("../ControllerFirst/wwwroot/reset.html", FileMode.Open);
        using StreamReader sr = new(fs);
        StringBuilder sb = new(await sr.ReadToEndAsync());
